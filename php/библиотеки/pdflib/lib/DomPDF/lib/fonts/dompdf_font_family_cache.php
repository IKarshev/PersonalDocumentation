...
return array (
  ...
  'times-new-roman' => array(
    'normal' => $fontDir . '/times-new-roman',
    'bold' => $fontDir . '/times-new-roman',
    'italic' => $fontDir . '/times-new-roman',
    'bold_italic' => $fontDir . '/times-new-roman',
  ),
  'times-new-roman-bold' => array(
    'normal' => $fontDir . '/times-new-roman-bold',
    'bold' => $fontDir . '/times-new-roman-bold',
    'italic' => $fontDir . '/times-new-roman-bold',
    'bold_italic' => $fontDir . '/times-new-roman-bold',
  ),
);
}; ?>